// Differential op-coverage kernel for `reduce_tile` over an all-negative input
// tile (see reduceneg.cpp for why the sign matters). Reduces the *same*
...
// the host (reduceneg.cpp) to match.
